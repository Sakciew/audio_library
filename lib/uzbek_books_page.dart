...
class UzbekBooksPage extends StatelessWidget {
  final List<Map<String, String>> books = [
    {"title": "O'tkan kunlar", "file": "audio1.mp3"},
    {"title": "Dunyoning ishlari", "file": "audio2.mp3"},
    {"title": "Chinor", "file": "audio3.mp3"},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("O'zbek adabiyoti", style: TextStyle(color: Colors.white)),
